...
data class ForecastDetailsFragmentArgs(
  val temp: Float,
  ...
  companion object {
    @JvmStatic
    fun fromBundle(bundle: Bundle): ForecastDetailsFragmentArgs {
      bundle.setClassLoader(ForecastDetailsFragmentArgs::class.java.classLoader)
      val __temp : Float
      ...
      return ForecastDetailsFragmentArgs(__temp, __description, __date, __icon)
    }
  }
}
