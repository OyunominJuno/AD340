...
class ForecastRepository {
    ...
    fun loadWeeklyForecast(zipcode: String) {
        ...
        call.enqueue(object : Callback<CurrentWeather> {
            override fun onFailure(call: Call<CurrentWeather>, t: Throwable) {
                Log.e(ForecastRepository::class.java.simpleName, "error loading current weather for weekly forecast", t)
            }
    ...
    private fun getTempDescription(temp: Float) : String {
        return when (temp) {
            in Float.MIN_VALUE.rangeTo(0f) -> "0? Someone did the math wrong"
            in 0f.rangeTo(32f) -> "Feels like home if you're Mongolian"
            in 32f.rangeTo(55f) -> "Grab your winter coat!"
            in 55f.rangeTo(65f) -> "Grab a sweater"
            in 65f.rangeTo(80f) -> "That's the sweet spot!"
            in 80f.rangeTo(90f) -> "Getting a little uncomfortably warm"
